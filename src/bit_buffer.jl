...
completed bit. The sign of each soft bit corresponds to the respective hard bit
returned by [`get_bits`](@ref). The buffer is reset to length 0 at the start of
each `track` call, mirroring the hard bit buffer.
"""
