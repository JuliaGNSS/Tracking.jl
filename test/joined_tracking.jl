@testset "Joined tracking" begin
    ...
    for i = 1:num_integrations
        ...
        l1_carrier_dopplers[i] = joined_results[1].carrier_doppler
        l5_carrier_dopplers[i] = joined_results[2].carrier_doppler
        l1_code_dopplers[i] = joined_results[1].code_doppler
        l5_code_dopplers[i] = joined_results[2].code_doppler
    end

    @test joined_results[1].carrier_doppler ≈ l1_doppler atol = 5e-2
    @test joined_results[2].carrier_doppler ≈ l5_doppler atol = 5e-2
    ...
    @test joined_results[1].code_doppler ≈ l1_code_doppler atol = 5e-5
    @test joined_results[2].code_doppler ≈ l5_code_doppler atol = 5e-4
