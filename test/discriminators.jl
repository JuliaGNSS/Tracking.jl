...
@testset "DLL discriminator" begin
    test_signal_very_early = [0. + 0.0im, 0.5 + 0.0im, 1.0 + 0.0im] #τ = 0.5
    test_signal_early = [0.25 + 0.0im, 0.75 + 0.0im, 0.75 + 0.0im] #τ = 0.25
    test_signal_in_time = [0.5 + 0.0im, 1 + 0.0im, 0.5 + 0.0im] #τ = 0
    test_signal_late = [0.75 + 0.0im, 0.75 + 0.0im, 0.25 + 0.0im] #τ = -0.25
    test_signal_very_late = [1.0 + 0.0im, 0.5 + 0.0im, 0.0 + 0.0im] #τ = -0.5
