@testset "Correlator" begin
    ...
    @testset "Correlator constructor" begin
        ...
        correlator = @inferred EarlyPromptLateCorrelator(gpsl1, sampling_frequency, num_ants = NumAnts(1), num_accumulators = 3)
        ...
        correlator = @inferred EarlyPromptLateCorrelator(gpsl1, sampling_frequency, num_ants = NumAnts(1))
        ...
        correlator = @inferred EarlyPromptLateCorrelator(gpsl1, sampling_frequency, num_ants = NumAnts(2))
        ...
        correlator = @inferred EarlyPromptLateCorrelator(gpsl1, sampling_frequency, num_ants = NumAnts(2), num_accumulators = 3)
